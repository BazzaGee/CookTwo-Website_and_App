## V2 Adaptation Note
This document describes the V1 single-mode meal picker (Tab 3). For V2, the Meal Plan tab now has TWO modes: "Cook Now" and "I Want This". See `V2_Design/V2_Feature_Breakdown.md` for the updated tab specifications. The product loop concept remains the same — only the entry point has changed. All other tabs (Shopping, Pantry, Profiles, Settings) and the adaptive cooking moat remain unchanged.

---

# Couples Food System — Feature Breakdown (V1 Source — Adapted for V2)
