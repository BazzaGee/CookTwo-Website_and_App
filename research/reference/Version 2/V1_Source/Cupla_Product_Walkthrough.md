## V2 Adaptation Note
This walkthrough describes the V1 single-mode meal picker. For V2, the Meal Plan tab now has TWO modes: "Cook Now" (zero shopping, pantry-first) and "I Want This" (browse, pick, see what's missing). See `V2_Design/V2_Product_Walkthrough.md` for the updated walkthrough. All other tabs (Shopping, Pantry, Profiles, Settings) and the adaptive cooking layer remain unchanged.

---

# Couples Food System — Product Walkthrough (V1 Source — Adapted for V2)
