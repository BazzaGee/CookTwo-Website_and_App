## V2 Adaptation Note
This document describes the V1 7-step build order with a single-mode meal picker. For V2, Steps 5-6 are replaced by the dual-mode meal picker (Cook Now + I Want This). The updated build order is in `V2_Design/V2_Build_Order.md`. Steps 1-4 (Foundation) and Step 7 (Adaptive Cooking) remain unchanged.

---

# Cupla — Product Development Steps (V1 Source — Adapted for V2)
